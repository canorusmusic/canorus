...
def newDefaultDocument(document)
	...
	staff1voice1 = Voice.new(staff1, "Staff1Voice1", 1, Note.StemUp)
	staff1.addVoice(staff1voice1)
	staff1voice2 = Voice.new(staff1, "Staff1Voice2", 2, Note.StemDown)
	...
	staff2voice1 = Voice.new(staff2, "Staff2Voice1", 1, Note.StemUp)
	staff2.addVoice(staff2voice1)
	staff2voice2 = Voice.new(staff2, "Staff2Voice2", 1, Note.StemDown)
