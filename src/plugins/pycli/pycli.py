"""
	Copyright (c) 2006-2008, Stefan Sakalik, Reinhard Katzmann, Matevz Jekovec, Canorus development team
	All Rights Reserved. See AUTHORS for a complete list of authors.

	Based on code inspired by similar code by Jeff Epler and Fredrik Lundh. :)
...
class CanorusConsoleInterfaceOUT:
	...
	The class redirects STDOUT and STDERR to console in canorus
	"""	

	def __init__(self, canorusInterface, stdErrMod):
		"""Constructor. It takes a link to canorus consle as a parameter 
		"""
...
class CanorusConsoleInterfaceIN:
	...
	The class redirects STDIN to console in canorus
	"""

	def __init__(self, canorusInterface):
		"""Constructor. It takes a link to canorus consle as a parameter 
		"""
		self.canorusInterface = canorusInterface
